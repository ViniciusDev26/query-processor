...
export const MermaidGraphView: React.FC<Props> = ({ mermaidOriginal, mermaidOptimized }) => {
    ...
    useEffect(() => {
        const renderDiagram = async () => {
            ...
            } else if (activeTab === "optimized" && mermaidOptimized && optimizedRef.current) {
                optimizedRef.current.innerHTML = "";
                const { svg } = await mermaid.render("optimized-graph", mermaidOptimized);
